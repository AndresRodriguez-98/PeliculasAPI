...
namespace PeliculasAPI.Datos
{
    public class ApplicationDBContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // 👇 IMPORTANTE: Evita conflictos con claves primarias fijas en el seeding
            modelBuilder.Entity<Actor>().Property(x => x.Id).ValueGeneratedNever();
            modelBuilder.Entity<Genero>().Property(x => x.Id).ValueGeneratedNever();
            modelBuilder.Entity<Pelicula>().Property(x => x.Id).ValueGeneratedNever();
            modelBuilder.Entity<SalaCine>().Property(x => x.Id).ValueGeneratedNever();
